...
class Assets(object):
    ...
    def sell(self, amount_of_net_cash_to_get_back, day, short_term_cap_gains_rate, long_term_cap_gains_rate):
        ...
        list_to_sort = [(lot.capital_gains_tax(day, short_term_cap_gains_rate, long_term_cap_gains_rate), lot) for lot in self.__lots_list]
        ...
        while cash_still_need_to_get > 0:
            (cash_still_need_to_get, lot_emptied) = self.__lots_list[0].sell(cash_still_need_to_get, day, short_term_cap_gains_rate, long_term_cap_gains_rate)
            if lot_emptied:
